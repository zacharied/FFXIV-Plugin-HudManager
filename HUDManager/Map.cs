...
namespace HUDManager
{
    internal class Map
    {
        ...
        private static Lumina.Excel.ExcelSheet<Lumina.Excel.GeneratedSheets.Map> GetSheet(DataManager data)
        {
            if (_sheet is null)
        ...
        public static List<Map> GetZoneMaps(DataManager data)
            => GetSheet(data)
        ...
        public static uint? GetRootZoneId(DataManager data, uint territoryType)
        {
